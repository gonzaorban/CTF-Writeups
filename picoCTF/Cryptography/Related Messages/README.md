...
* `script.sage`: Script utilizado para calcular el máximo común divisor de los polinomios.
...
![SageMath ejecutando el Franklin-Reiter Related Message Attack y recuperando la bandera con el typo](./assets/CTF_2026-03-13_17-09-49.jpeg)
*El GCD de los polinomios recupera el texto plano: `picoCTF{m3ssage_w1th_typ0z` (con el error tipográfico final).*
