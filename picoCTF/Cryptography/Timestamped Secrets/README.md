...
* `script.py`: Script utilizado para la automatización del ataque.
...
![Ejecución de script.py: fuerza bruta del timestamp encontrando el valor exacto y la flag](./assets/CTF_2026-03-13_17-22-45.png)
*El barrido de timestamps encuentra la clave (offset 0s) y descifra el mensaje.*
