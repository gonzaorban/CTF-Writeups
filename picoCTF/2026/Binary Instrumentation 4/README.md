...
* `flag_generator4.exe`: Binario final extraído y analizado.
...
[INSERTAR IMAGEN AQUÍ: Captura de la terminal mostrando el comando file de la sección extraída con el indicador de LZMA compressed data]
...
[INSERTAR IMAGEN AQUÍ: Captura del descompilador de Ghidra mostrando las llamadas a socket, connect, send, recv y lstrcmpA]
...
[INSERTAR IMAGEN AQUÍ: Captura de Ghidra mostrando la inicialización estática de las cadenas o las cadenas en la vista Listing]
...
[INSERTAR IMAGEN AQUÍ: Captura de la terminal de Kali Linux mostrando el comando base64 -d revelando la bandera final]
