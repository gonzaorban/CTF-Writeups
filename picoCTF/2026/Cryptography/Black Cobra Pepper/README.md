...
* `script.py`: Script de explotación que recupera la flag usando un Known-Plaintext Attack.
...
Ejecutando `script.py` obtenemos la flag sin necesidad de fuerza bruta ni conocer la key secreta:
...
![Ejecución de script.py mostrando el KPA: L(pt1), L(flag) y la flag recuperada](./assets/CTF_2026-03-13_17-22-53.png)
*El ataque de texto plano conocido recupera la flag sin la key: `picoCTF{spi1cy!}`.*
